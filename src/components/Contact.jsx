...
const Contact = ({name, link, icon}) => {
  ...
  <Link
    target="_blank"
    href={link}
    className={`${icon} p-2 group flex justify-center rounded-md drop-shadow-xl from-gray-800 text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413] w-fit`}
  >
